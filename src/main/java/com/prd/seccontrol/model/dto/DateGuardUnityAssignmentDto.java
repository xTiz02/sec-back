...
public record DateGuardUnityAssignmentDto(
  ...
  public DateGuardUnityAssignmentDto(DateGuardUnityAssignment dateGuardUnityAssignment){
    this(
        ...
        dateGuardUnityAssignment.getGuardUnityScheduleAssignment() != null ? new GuardUnityScheduleAssignmentDto(dateGuardUnityAssignment.getGuardUnityScheduleAssignment()) : null,
